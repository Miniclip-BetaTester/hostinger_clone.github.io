...
const Pricing = () => {
    return (
        <div>
            <section data-aos={"fade-up"} class="  bg-gradient-to-r from-pink-300 to-sky-300   sm:py-16 ">
                <div class=" mx-auto max-w-7xl sm:px-6 ">
                    <div class="max-w-2xl mx-auto text-center">
                        ...
                        <p class="max-w-xl  mt-4 font-semibold leading-relaxed text-gray-700 ">We prepared the best web hosting plan for you to start. You will be able to adjust plans as you go - our custom-built algorithm will provide suggestions based on your usage.</p>
                    </div>

                    <div data-aos={"fade-right"} class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 text-center lg:max-w-full lg:mt-16 lg:grid-cols-3">
                        <div class="overflow-hidden bg-white border-2 border-gray-100 rounded-md">
                            <div class="p-8 xl:px-12">
                                <h3 class="text-base font-semibold text-purple-600">12 MONTHS</h3>
                        ...
                        <div data-aos={"fade-right"} class="overflow-hidden bg-white border-2 border-gray-100 rounded-md shadow-lg">
                            <div class="p-8 xl:px-12">
                                <h3 class="text-base font-semibold text-purple-600">24 MONTHS</h3>
                        ...
                        <div data-aos={"fade-right"} class="overflow-hidden bg-white border-2 border-gray-100 rounded-md">
                            <div class="p-8 xl:px-12">
                                <h3 class="text-base font-semibold text-purple-600">48 MONTHS</h3>
