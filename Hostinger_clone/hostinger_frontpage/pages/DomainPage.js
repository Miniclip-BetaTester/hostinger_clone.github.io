...
const DomainPage = () => {
    return (
        <div>
            <section data-aos={"fade-right"} class="py-10 bg-gray-100 sm:py-16 bg-gradient-to-r from-pink-300 to-sky-300">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="max-w-4xl mx-auto text-left sm:text-center">
                        <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Find the perfect domain name</h2>
                    </div>
                    ...
                    <form action="#" method="POST" class="max-w-xl mx-auto mt-12">
                        <div class="sm:p-2 sm:bg-white sm:border-2 sm:border-transparent sm:rounded-full sm:focus-within:border-blue-600 sm:focus-within:ring-1 sm:focus-within:ring-blue-600">
                            <div class="flex flex-col items-start sm:flex-row sm:justify-center">
                                ...
                                <button type="submit" class="inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-3xl sm:ml-4 sm:mt-0 sm:w-auto hover:bg-blue-700 focus:bg-blue-700">
                                    Search
                    ...
                    <div class="flex items-center justify-start mt-8 sm:justify-center sm:px-0">
                        ...
                        <span class="ml-2 text-sm text-gray-600"> Enter domain name of your choice and pick any extension name on the next step (choose between .in, .com, .online, .live, .store, .info and many more). </span>
                    </div>
                </div>
            </section>
        </div>
