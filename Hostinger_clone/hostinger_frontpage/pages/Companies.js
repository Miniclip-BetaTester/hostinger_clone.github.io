...
const Companies = () => {
    return (
        <div>
            <section data-aos={"fade-right"} class="sm:py-16 bg-gradient-to-r from-pink-300 to-sky-300 ">
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="max-w-2xl mx-auto text-center">
                        <h2 class="text-3xl font-bold text-gray-800 sm:text-4xl sm:leading-tight">Trusted by world class companies, design teams & popular designers</h2>
                    </div>
